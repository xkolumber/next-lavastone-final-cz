...
export const generateEmailContactPage = ({
  name,
  email,
  number,
  images,
    ...
    <body>
      <div class="main">
        <div class="container">
          ...
          <div class="questions">
            <p class="questions_q">Meno: ${name}</p>
            <p class="questions_q">Email: ${email}</p>
            <p class="questions_q">Číslo: ${number}</p>
            <p class="questions_q">Služba: ${service}</p>
            <p class="questions_q">Správa: ${message}</p>
            <p class="questions_q">Zoznam obľúbených obrázkov:   ${imagesHtml}</p>
          </div>
